...
public class MatriculasModalidades {
    ...
    public MatriculasModalidades() {
        
    }

    public MatriculasModalidades(int codigoMatricula, String modalidade, String graduacao, String plano, Date dataInicio, Date dataFim) {
